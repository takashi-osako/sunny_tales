define(['jqueryui', 'jqueryLayout', 'underscore', 'backbone', '../models/report_component', '../collections/report_components'], function($, layout, _, Backbone, ReportComponent_, ReportComponents_) {
